...
module.exports = function(req, res) {
    if (req.session.user && req.session.user.has_voted)
        ...
        var post_opts = {
            ...
            uri:  this.settings.env == 'production' ? 'https://docs.google.com/spreadsheet/formResponse?formkey=dDI5dUg1TFMzUENKc09lSXp5aTh2alE6MQ&ifq' : 'https://docs.google.com/spreadsheet/formResponse?formkey=dHF0a0hVZmMtSWJYRUNrdkx0VnZBV0E6MA',
            headers: {
